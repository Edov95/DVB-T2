...
analyze_class(const mxArray *array_ptr)
{
    ...
    if (mxIsSparse(array_ptr)) {
        ...
        switch (category) {
            case mxLOGICAL_CLASS: analyze_logical(array_ptr); mexPrintf("\nLogical\n");    break;
            case mxCHAR_CLASS:    analyze_string(array_ptr); mexPrintf("\nChar\n");    break;
            case mxSTRUCT_CLASS:  analyze_structure(array_ptr); mexPrintf("\nStruct\n");  break;
            case mxCELL_CLASS:    analyze_cell(array_ptr); mexPrintf("\nCell\n");      break;
            case mxUNKNOWN_CLASS:
                mexWarnMsgIdAndTxt("MATLAB:explore:unknownClass",
                                   "Unknown class.");            break;
            default:              analyze_full(array_ptr); mexPrintf("\nDefault\n");      break;
        }
    }
